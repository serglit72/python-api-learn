...
class TestUserAuth:
    def test_auth_user(self):
        ...
        assert "auth_sid" in response1.cookies, "There is no cookie in the response"
        ...
        assert user_id_from_auth_method == user_id_from_check_method,"User id is different from check method"